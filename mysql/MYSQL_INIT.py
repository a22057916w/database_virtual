...
def MYSQL_INIT():
    func = [SQL_LEASE_TPE, SQL_LEASE_NTC, SQL_LEASE_IMG, SQL_SELLS_TPE, SQL_SELLS_NTC, SQL_SELLS_IMG, SQL_LEASE_TOTAL_TPE, SQL_LEASE_TOTAL_NTC, SQL_SELLS_TOTAL_TPE, SQL_SELLS_TOTAL_NTC]
    index = len(func)
    p = [None] * index
